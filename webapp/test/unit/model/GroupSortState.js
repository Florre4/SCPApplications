sap.ui.define([
	...
	QUnit.test("Should always return a sorter when sorting", function(assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("FAMNAAM").length, 1, "The sorting by FAMNAAM returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by FAMNAAM and there was a grouping before", function(assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("FAMNAAM");
