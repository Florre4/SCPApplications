...
sap.ui.define([
	...
	return BaseController.extend("wiwcloud.controller.Master", {
		...
		onSearch: function(oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter([
    				new Filter("FAMNAAM", FilterOperator.Contains, sQuery),
    				new Filter("VOORNAAM", FilterOperator.Contains, sQuery)],false)];
			} else {
				...
				function(mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							MANDT: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("MANDT")),
							HOOFDPERNR: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("HOOFDPERNR"))
						}, true);
					}
				}.bind(this),
				function(mParams) {
		...
		_showDetail: function(oItem) {
			...
			this.getRouter().navTo("object", {
				MANDT: encodeURIComponent(oItem.getBindingContext().getProperty("MANDT")),
				HOOFDPERNR: encodeURIComponent(oItem.getBindingContext().getProperty("HOOFDPERNR"))
			}, bReplace);
		},
