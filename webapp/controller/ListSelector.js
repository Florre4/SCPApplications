sap.ui.define([
	...
	return BaseObject.extend("wiwcloud.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias wiwcloud.model.ListSelector
		 */
		 ...
		 * @return {wiwcloud.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
