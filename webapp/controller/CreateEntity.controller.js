sap.ui.define([
	...
	return BaseController.extend("wiwcloud.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("Person", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("Person", oData);
