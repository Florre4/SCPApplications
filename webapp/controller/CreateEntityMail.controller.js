sap.ui.define([
	...
	return BaseController.extend("wiwcloud.controller.CreateEntityMail", {
		...
		onInit: function() {
			var that = this;
			this.getRouter().getTargets().getTarget("createMail").attachDisplay(null, this._onDisplay, this);
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("Email", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("Email", oData);
