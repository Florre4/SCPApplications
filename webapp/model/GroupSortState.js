sap.ui.define([
	...
	return BaseObject.extend("wiwcloud.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias wiwcloud.model.GroupSortState
		 */
		...
		group: function(sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "FAMNAAM");
			}
